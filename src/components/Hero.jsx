...
const Hero = () => {
  ...
  return (
    <section className="relative py-20 lg:py-0 bg-[#FBFDFB] dark:bg-[#001720] border-b-[8px] border-white dark:border-[#001f2b] overflow-hidden min-h-[85vh] flex items-center transition-colors duration-500">
      <div className="w-full max-w-[1400px] mx-auto px-10 xl:px-20 flex flex-col md:flex-row items-center justify-between">
        <div className="w-full md:w-[45%] z-10 pr-0 md:pr-10 mb-20 md:mb-0">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            >
              {t("hero.membership_registration")}
